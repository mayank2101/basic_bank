    ...
    if (($amount)<0)
   {
    ...
    // constraint to check zero values
         ...
         echo "</script>";
                ...
                if($query){
                     echo "<script> alert('transactions Successful');
                                     window.location='transac.php';
                           </script>";
	...
	<div class="container btn2">
        ...
        <div>
            <table class="table table-striped table-condensed table-bordered">
                <tr>
                    <th class="text-center tbtext">Id</th>
                    <th class="text-center tbtext">Name</th>
                    <th class="text-center tbtext">Email</th>
                    <th class="text-center tbtext">Balance</th>
                </tr>
                <tr>
